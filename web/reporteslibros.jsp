<%-- 
    Document   : reporteslibros
    Created on : 04-sep-2022, 11:05:08
    Author     : USUARIO
--%>
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive">        
                                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td data-titulo="ID">Tiger Nixon</td>
                                                <td data-titulo="CODIGO ALFANUMERICO">Arquitecto</td>
                                                <td data-titulo="AÑO PUBLICACION">Edinburgh</td>                                
                                                <td data-titulo="EDICION">2011/04/25</td>
                                                <td data-titulo="TITULO">$320,800</td>
                                                <td data-titulo="EDITORIAL">Tiger Nixon</td>
                                                <td data-titulo="ISBN">Arquitecto</td>
                                                <td data-titulo="STOCK">Edinburgh</td>                                
                                                <td data-titulo="TIPO">2011/04/25</td>
                                                <td data-titulo="CD">$320,800</td>
                                                <td data-titulo="VIGENCIA">$320,800</td>
                                                <td data-titulo="NOMBRES">Edinburgh</td>                                
                                                <td  data-titulo="APELLIDOS">2011/04/25</td>
                                                <td data-titulo="CIUDAD">$320,800</td>
                                                <td data-titulo="PAIS">$320,800</td>
                                            </tr>
                                            <tr>
                                               <td data-titulo="ID">Tiger Nixon</td>
                                                <td data-titulo="CODIGO ALFANUMERICO">Arquitecto</td>
