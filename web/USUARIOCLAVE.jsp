<%-- 
    Document   : USUARIOCLAVE
    Created on : 04-sep-2022, 13:38:28
    Author     : USUARIO
--%>
            ...
            <div id="content">
                ...
                <div class="top-navbar">
                    ...
                    <header>
                        ...
                        <h2 class="text-center text-light">DE<span class="badge badge-warning">REPORTES</span></h2> 
                    </header>    
